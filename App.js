...
const Phone = () => <div className="header-phonelink"><a href="tel:7(962)556-1234">+7(962)556-1234</a></div>,
	SliderItem = props =>
		<div className="features-slider_item">
			<div className="features-img"
				style={props.url}></div>
			<div className="features-feature">{props.advantages} целевое преимущество</div>
		</div>;
		...
		<main>
			<div className="wrapper">
				<div className="main">
					...
					<div className="main-small">Описания предлжения компании.
				...
				<div className="features-wrapper">
					...
					<div className="features-slider">
						<div className="features-slider_items">
							<SliderItem url={{ backgroundImage: 'url(./images/1.svg)' }} advantages="Первое"/>
							<SliderItem url={{ backgroundImage: 'url(./images/2.svg)' }} advantages="Второе"/>
							<SliderItem url={{ backgroundImage: 'url(./images/3.svg)' }} advantages="Третье"/>
							<SliderItem url={{ backgroundImage: 'url(./images/4.svg)' }} advantages="Четвертое"/>
						</div>
						<button className="features-slider-arrow features-slider-prev">
							<svg width="9" height="16"
								xmlns="http://www.w3.org/2000/svg">
								<path
									d="M8.707 8.707a1 1 0 0 0 0-1.414L2.343.929A1 1 0 1 0 .93 2.343L6.586
                                    8 .929 13.657a1 1 0 0 0 1.414 1.414l6.364-6.364zM7 9h1V7H7v2z">
								</path>
							</svg>
						</button>
